...
const Portfolio = () => {
  return (
    <section className="padding" id="portfolio">
      <h2 style={{ fontWeight: "bold", fontSize: "3rem", textAlign: "center" }}>Portfolio</h2>
      <div style={{ display: "flex", flexDirection: "row", paddingTop: "3rem" }}>
        ...
        <div className="container">
          {projectList.map((project) => (
            <div className="box" key={project.title} style={{ borderRadius: "1rem" }}>
              <a href={project.url} target="_blank" rel="noopener noreferrer">
                <h3 style={{ flexBasis: "50px", fontWeight: "bold", fontFamily: "sans-serif" }}>
                  {project.title}
                </h3>
              </a>
              <p className="small" style={{ fontWeight: "normal", color: "grey" }}>
                {project.description}
              </p>
            </div>
          ))}
